...
(function() {
  ...
  VAT = (function() {
    function VAT(data) {
      ...
      this.getDIC = bind(this.getDIC, this);
  ...
  GovData = (function() {
    function GovData() {
      this.findByICO = bind(this.findByICO, this);
    ...
    GovData.prototype.findByICO = function(ico, resolve, reject) {
      return this.get('ico/' + ico, (function(_this) {
