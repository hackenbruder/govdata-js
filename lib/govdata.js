...
(function() {
  ...
  (function() {
    var Account, Address, Entity, Error, GovData, Helpers, RUIAN, SearchResult, SearchResults, Status, VAT, https, url;
    ...
    Status = (function() {
      function Status(data) {
        this.hasService = bind(this.hasService, this);
        this.get = bind(this.get, this);
        this.getServices = bind(this.getServices, this);
        this.timestamp = data.timestamp;
        this.services = data.services;
        Object.keys(data.services).map(function(key) {
          var difference, service;
          service = data.services[key];
          difference = data.timestamp - service.updated_at;
          return service.status = difference < service.frequency;
        });
      }

      Status.prototype.getServices = function() {
        return Object.keys(this.services);
      };

      Status.prototype.get = function(service) {
      ...
      Status.prototype.hasService = function(service) {
        return (this.services != null) && this.services.hasOwnProperty(service);
      };
    ...
    SearchResult = (function() {
      function SearchResult(data) {
        ...
        this.getNumber = bind(this.getNumber, this);
        this.data = data;
        this.foundedAt = Helpers.getDate(data.founded_at * 1000);
      }
      ...
      SearchResult.prototype.getName = function() {
        return this.data.name;
      };

      SearchResult.prototype.getGeo = function() {
        return [this.data.lat, this.data.lon];
      };

      SearchResult.prototype.getFoundedAt = function() {
        return this.foundedAt;
      };

      SearchResult.prototype.hasGeo = function() {
        return (this.data.lat != null) && (this.data.lon != null);
      };
    ...
    SearchResults = (function() {
      function SearchResults(data) {
        ...
        if (!Array.isArray(this.data.data)) {
          ...
          this.results = this.data.data.map(function(result) {
            return new SearchResult(result);
          });
        }
      }

      SearchResults.prototype.getPages = function() {
        return this.data.pages;
      };

      SearchResults.prototype.getCount = function() {
    ...
    GovData = (function() {
      function GovData() {
        this.findEntitiesByGeo = bind(this.findEntitiesByGeo, this);
      ...
      GovData.prototype.getParams = function(params) {
        return Object.keys(params).map(function(key) {
          return encodeURIComponent(key) + '=' + encodeURIComponent(params[key]);
        }).join('&');
      };

      GovData.prototype.getStatus = function(resolve, reject) {
        return this.get('status', (function(_this) {
          return function(data) {
            return resolve(_this.createStatus(data));
          };
        })(this), reject);
      };
      ...
      GovData.prototype.findEntitiesByGeo = function(latitude, longitude, radius, page, resolve, reject) {
        var params;
        ...
        return this.get('search/geo?' + params, (function(_this) {
          return function(data) {
            return resolve(_this.createSearchResults(data));
          };
        })(this), reject);
      };

      GovData.prototype.createStatus = function(data) {
        return new Status(data);
      };

      GovData.prototype.createSearchResults = function(data) {
